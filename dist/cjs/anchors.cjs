...
exports.centerAnchor = centerAnchor;
exports.sideAnchor = sideAnchor;
exports.nearestSideMidAnchor = nearestSideMidAnchor;
exports.chooseNearestSide = chooseNearestSide;
exports.nearestEdgeAnchor = nearestEdgeAnchor;
exports.resolveAnchor = resolveAnchor;
const ports_1 = require("./ports");
function centerAnchor(node) {
...
function nearestEdgeAnchor(node, toward) {
...
function resolveAnchor(node, spec, toward) {
    ...
    if (spec.type === "port") {
        ...
        if (ports?.length) {
            if (spec.portId) {
                ...
                if (found)
                    return (0, ports_1.portAnchor)(node, found);
            }
            const nearest = (0, ports_1.findNearestPort)(node, toward);
            if (nearest)
                return (0, ports_1.portAnchor)(node, nearest);
        }
        return nearestEdgeAnchor(node, toward);
    }
    return centerAnchor(node);
